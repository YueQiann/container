package com.qianyue.container.ui.report;
...
public class ReportActivity extends BaseLayoutActivity implements View.OnClickListener {
    ...
    protected void initView(@Nullable Bundle savedInstanceState) {
        hasFirst = true;
        InitTopView.initTitle("查看报表", this);
        initBtn();
        loadView();
    }
    ...
    private void addToView() {
        ...
        linearLayoutCompat.addView(btnStyle1(false, "领取报表", R.id.item_report_receive_btn));
        linearLayoutCompat.addView(btnStyle1(true, "补货报表", R.id.item_report_supply_btn));
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.item_report_receive_btn:
                UIhelper.gotoReceiveActivity(this);
                break;
            case R.id.item_report_supply_btn:
                UIhelper.gotoReportSupplyActivity(this);
                break;
        }
    }
}
